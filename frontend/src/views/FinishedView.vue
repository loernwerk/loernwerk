...
.firework:nth-child(2)::after {
  --color1: rgb(223, 149, 161);
  --color2: rgb(230, 90, 125);
  --color3: rgb(255, 0, 98);
  --color4: rgb(187, 79, 79);
  --color5: rgb(175, 25, 45);
  --color6: rgb(230, 13, 31);
  --finalSize: 40vmin;
  left: 30%;
  top: 60%;
...
.firework:nth-child(3)::after {
  --color1: rgb(39, 161, 218);
  --color2: rgb(81, 137, 219);
  --color3: rgb(60, 91, 175);
  --color4: rgb(23, 76, 221);
  --color5: rgb(34, 42, 151);
  --color6: rgb(13, 13, 114);
  --finalSize: 35vmin;
  left: 70%;
  top: 60%;
